(function() {
                        ...
                        <form id="quoteForm" action="${webhookUrl}" method="POST" novalidate>
                            ...
                            <div class="section" id="main-section">
                                ...
                                <div class="field-wrapper">
                                    <input type="text" id="cleaning_date_display" name="cleaning_date_display" readonly placeholder="Välj datum..." required>
                                    <input type="date" id="cleaning_date_picker" style="display:none;">
                                    <label for="cleaning_date_display">Städdatum</label>
                                </div>
                                <div class="field-wrapper">
    ...
    // Hantera städdatum
    const dateDisplay = document.getElementById('cleaning_date_display');
    const datePicker = document.getElementById('cleaning_date_picker');
    const dateHidden = document.getElementById('cleaning_date_hidden');

    if (dateDisplay && datePicker && dateHidden) {
        ...
        datePicker.addEventListener('change', () => {
            ...
            if (selected) {
                dateDisplay.value = formatDisplayDate(selected);
                dateHidden.value = formatWebhookDate(selected);
            }
        });
    }
    ...
    function formatWebhookDate(dateStr) {
        if (!dateStr) return '';
        const date = new Date(dateStr);
        if (isNaN(date.getTime())) return dateStr;
