(function() {
    ...
    style.textContent = `
        ...
        .trigger-btn{position:fixed;top:16px;right:16px;z-index:1000;padding:12px 24px;background:#e74c3c;color:#fff;border:none;border-radius:8px;font-size:1rem;font-weight:600;cursor:pointer;box-shadow:0 4px 12px rgba(231,76,60,0.4);transition:all .3s}
        .trigger-btn:hover{background:#c0392b;transform:translateY(-2px);box-shadow:0 8px 24px rgba(231,76,60,0.6)}
        ...
        .field-wrapper textarea:focus+label,.field-wrapper textarea:not(:placeholder-shown)+label{
            top:0;                      /* ← ändrat till top:0 för label vid fokus/ifyllt */
            left:12px;font-size:10px;transform:translateY(0);background:transparent
        }
        input,select,textarea{width:100%;padding:14px 16px;background:rgba(255,255,255,0.55);backdrop-filter:blur(8px);-webkit-backdrop-filter:blur(8px);border:1px solid rgba(0,0,0,0.08);border-radius:8px;font-family:'Inter',sans-serif;font-size:14px;line-height:1.5;color:#1a1a1a;box-sizing:border-box;transition:border-color .2s ease}
        input[type=text],input[type=tel],input[type=email]{padding:14px 16px} /* ← säkerställer 14px padding */
        ...
        textarea{min-height:80px;resize:vertical;font-family:'Inter',sans-serif;font-size:14px;line-height:1.5;color:#1a1a1a}
