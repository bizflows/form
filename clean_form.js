(function() {
    ...
    style.textContent = `
        ...
        .field-wrapper input:focus+label,.field-wrapper input:not(:placeholder-shown)+label,.field-wrapper select:focus+label,.field-wrapper select:not(:placeholder-shown)+label,.field-wrapper textarea:focus+label,.field-wrapper textarea:not(:placeholder-shown)+label{top:0px;left:12px;font-size:10px;transform:translateY(0);background:transparent}
        ...
        <div class="modal" id="quoteModal">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="quoteForm" action="https://hook.eu1.make.com/kwnhnpzfpt353a8auu9nfh3jsheog3hk" method="POST" novalidate>
