(function() {
    ...
    style.textContent = `
        ...
        .field-wrapper input:focus+label,.field-wrapper input:not(:placeholder-shown)+label,.field-wrapper select:focus+label,.field-wrapper select:not(:placeholder-shown)+label,.field-wrapper textarea:focus+label,.field-wrapper textarea:not(:placeholder-shown)+label{top:-2px;left:12px;font-size:10px;transform:translateY(0);background:transparent}
