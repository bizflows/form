(function() {
    ...
    style.textContent = `
        ...
        .field-wrapper input:focus+label,.field-wrapper input:not(:placeholder-shown)+label,.field-wrapper select:focus+label,.field-wrapper select:not(:placeholder-shown)+label,.field-wrapper textarea:focus+label,.field-wrapper textarea:not(:placeholder-shown)+label{top:4px;left:12px;font-size:10px;transform:translateY(0);background:transparent}
        input,select,textarea{width:100%;padding:14px 16px;background:rgba(255,255,255,0.55);backdrop-filter:blur(8px);-webkit-backdrop-filter:blur(8px);border:1px solid rgba(0,0,0,0.08);border-radius:8px;font-family:'Inter',sans-serif;font-size:14px;line-height:1.4;color:#1a1a1a;box-sizing:border-box;transition:border-color .2s ease}
