(function() {
    ...
    // Hämta webhook-URL från data-attribut (helt dolt)
    const webhookUrl = script ? script.getAttribute('data-webhook-url') || 'https://din-webhook-url-here.com' : 'https://din-webhook-url-here.com';
